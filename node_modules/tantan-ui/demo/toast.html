...
<body>
  ...
  <div class="tt-content">
    ...
    <div class="tt-panel-body">
      <a class="tt-btn tt-btn-primary" id="js-show-toast-loading">加载中提示</a>
      <br />
      <a class="tt-btn tt-btn-primary" id="js-show-toast-success">成功提示</a>
    </div>
  </div>
  ...
  <script>
    window.onload = () => {
      document.querySelector('#js-show-toast-loading').onclick = (e) => {
        let toastEl = document.querySelector('#js-toast-loading')
      ...
      document.querySelector('#js-show-toast-success').onclick = (e) => {
        let toastEl = document.querySelector('#js-toast-success')
        toastEl.classList.add('show')
        setTimeout(() => {
          toastEl.classList.remove('show')
        }, 2e3)
