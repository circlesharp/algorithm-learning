  ...
  <div class="tt-content">
    ...
    <div class="tt-panel-body no-padding">
      ...
      <div class="tt-form-item">
        ...
        <div class="tt-form-body">
          <input class="tt-input" type="date" placeholder="请输入姓名" />
        </div>
      </div>
    </div>
    ...
    <div class="tt-panel-body no-padding">
      <div class="tt-form-item">
        <div class="tt-check">
          ...
          <span class="tt-check-desc">多项选项1</span>
          <input class="tt-check-input" type="check">
        </div>
      </div>
      <div class="tt-form-item">
        <div class="tt-check checked">
          <i class="fa fa-check tt-check-icon"></i>
          <span class="tt-check-desc">多项选项2</span>
          <input class="tt-check-input" type="check">
        </div>
      </div>
      <div class="tt-form-item">
        <div class="tt-check checked">
          <i class="fa fa-check tt-check-icon"></i>
          <span class="tt-check-desc">多项选项3</span>
          <input class="tt-check-input" type="check">
        </div>
      </div>
    </div>
